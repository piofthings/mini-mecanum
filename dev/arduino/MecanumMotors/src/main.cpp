...
CytronSoftPwmMD motor1(PWM_SWPM, 10, 16);   // PWM 1A = Pin 10, PWM 1B = Pin 16.
CytronSoftPwmMD motor2(PWM_SWPM, 9, 8);     // PWM 2A = Pin 9, PWM 2B = Pin 8.
CytronSoftPwmMD motor3(PWM_SWPM, 5, 4);     // PWM 1A = Pin 5, PWM 1B = Pin 4.
CytronSoftPwmMD motor4(PWM_SWPM, 6, 7);     // PWM 2A = Pin 6, PWM 2B = Pin 7.
